...
<head>
    ...
    <link rel="stylesheet" href="style/card.xss">
    <title>Document</title>
</head>
<body>
        <div class="navbar bg-base-300 rounded-box">
            <div class="flex-1 px-2 lg:flex-none">
              <a class="text-lg font-bold">Rafael Lorenzo</a>
            </div> 
            <div class="flex justify-end flex-1 px-2">
              <div class="flex items-stretch">
                          <!-- The button to open modal -->
                    <label for="my-modal-3" class="btn modal-button rounded-xl mr-6">Get Started</label>
                ...
                <ul tabindex="0" class="menu menu-compact dropdown-content mt-3 p-2 shadow bg-001 rounded-box w-52" style="background-color:#0c1322;">
    ...
    <div class="app">
        ...
        <footer class="footer footer-center p-10 bg-primary text-primary-content ">
            <div>
              ...
              <p class="font-bold">
                Rafael Lorenzo<br>Front-end Engineering
              </p> 
